    ...
    <main className="max-w-md px-2 mx-auto">
      ...
      <form onSubmit={onSubmit}>
        ...
        <div className="flex">
          ...
          font-medium tex-sm uppercase shadow-md rounded
        ...
        <input
          ...
          minLength="10"
          required
          className="w-full px-4 py-2 tex-lg text-gray-700
            bg-white border border-gray-300 rounded transition
            duration-150 ease-in-out mb-6"
        />
          ...
          <div className=" flex space-x-6 justify-start mb-6">
            <div className="">
              ...
              <input
                ...
                transition duration-150 ease-in-out focus:bg-white focus:text-gray-700
                focus:border-slate-600 text-center"
              />
            </div>
            <div className="">
        ...
        bg-blue-600 text-white font-medium text-sm uppercase
        rounded shadow-md hover:bg-blue-700 focus:shadow-lg 
        active:bg-blue-80 active:shadow-lg transition 
