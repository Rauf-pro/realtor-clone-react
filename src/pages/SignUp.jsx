  ...
  async function onSubmit(e){
     ...
     try {
      ...
      navigate("/");
       ...
       toast.error("Something went wrong the registrtation")
    ...
    <section>
      ...
      <div className="flex justify-center flex-wrap items-center px-6 py-12 max-w-6xl mx-auto">
        ...
        <div className="w-full md:w-[67%] lg:w-[40%] lg:ml-20 ">
          ...
          <div className=" flex items-center my-4 before:border-t flex before:flex-1 items-center after:border-gray-300 after:border-t flex after:flex-1 items-center after:border-gray-300">
